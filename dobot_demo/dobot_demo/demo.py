...
class adderClient(Node):
    def __init__(self, name):
        ...
        # ROS keyboard-listener
        self.keyup_sub = self.create_subscription(
            Key, "keydown", self.sub_cb, qos.qos_profile_system_default
        )
    ...
    def sub_cb(self, msg):
        self.get_logger().info(f'press {msg.code}')
...
def main(args=None):
    ...
    node = adderClient("nova_demo")                                    # 创建ROS2节点对象并进行初始化
